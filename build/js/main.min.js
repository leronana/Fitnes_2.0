...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/play-video.js":11,"./modules/swipers.js":12,"./utils/ios-vh-fix":15,"./vendor/init-accordion.js":18,"./vendor/init-tabs.js":19}],2:[function(require,module,exports){
"use strict";
...
var swiperTrainers = new Swiper('.trainers__swiper', {
  // Optional parameters
  loop: true,
  breakpoints: {
    320: {
  ...
  _createClass(Accordions, [{
    ...
    value: function fullUpdate() {
      ...
      openElements.forEach(function (openElement) {
        ...
        _this.openAccordion(openElement, transition);
      });
      this.updateAccordionsHeight();
    }
  }, {
